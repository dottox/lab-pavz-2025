...
//     DtCliente* cliente = new DtCliente("Juan Perez", 99123456, direccion);
...
//     DtCliente* cliente = new DtCliente("Maria Lopez", 987654321, direccion);
...
//     DtCliente* cliente = new DtCliente("Carlos Ruiz", 912345678, direccion);
//     VentaDomicilio venta(cliente);
...
//     // Crear VentaDomicilio
//     DtDireccion direccion("Calle Falsa", "123", "Entre A y B");
//     DtCliente* cliente = new DtCliente("Ana Torres", 987654321, direccion);
//     VentaDomicilio venta(cliente);
...
//     DtCliente* cliente = new DtCliente("Luis Garcia", 912345678, direccion);
//     VentaDomicilio venta(cliente);
...
//     DtCliente* cliente = new DtCliente("Sofia Martinez", 987654321, direccion);
//     VentaDomicilio* venta = new VentaDomicilio(cliente);
...
//     DtCliente* cliente = new DtCliente("Pedro Sanchez", 912345678, direccion);
//     VentaDomicilio venta(cliente);
...
//     DtDireccion direccion("", "-5", "");
//     CHECK_THROWS_AS(DtCliente("", -5, direccion), std::invalid_argument);
// }
...
//     DtCliente cliente("Elena Gomez", 912345678, direccion);
//     CHECK(cliente.getNombre() == "Elena Gomez");
//     CHECK(cliente.getTelefono() == 912345678);
